...
// Mock the hook
jest.mock('@/hooks/useProjectAchievementsForm')

const mockUseProjectAchievementsForm =
  useProjectAchievementsForm as jest.MockedFunction<
    typeof useProjectAchievementsForm
  >

describe('ProjectAchievements', () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockUseProjectAchievementsForm.mockReturnValue(defaultHookReturn)
  })

  describe('Rendering', () => {
    it('renders all achievements from the hook', () => {
      render(<ProjectAchievements projectIndex={0} />)
    ...
    it('renders with empty achievements list', () => {
      mockUseProjectAchievementsForm.mockReturnValue({
        ...defaultHookReturn,
        achievements: [],
      })
  ...
  describe('Variant Styling', () => {
    ...
    it('applies pink variant styles when specified', () => {
      render(<ProjectAchievements projectIndex={0} variant="pink" />)
    ...
    it('applies variant styles to achievement containers', () => {
      render(<ProjectAchievements projectIndex={0} variant="teal" />)
  ...
  describe('Hook Integration', () => {
    it('calls hook with correct project index', () => {
      render(<ProjectAchievements projectIndex={5} />)

      expect(mockUseProjectAchievementsForm).toHaveBeenCalledWith(5)
    })
