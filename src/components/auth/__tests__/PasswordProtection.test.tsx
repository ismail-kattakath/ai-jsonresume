...
describe('PasswordProtection Component', () => {
  ...
  beforeEach(() => {
    ...
    mockGetPasswordHash.mockReturnValue('$2b$10$DROkfTWOCqdekTKMKybP2eD9NIqTHNyAKFgsZCdpEXS9vC2honJfS');
  ...
  describe('Initial Render', () => {
    ...
    it('should render lock icon', () => {
      const { container } = render(<PasswordProtection>{mockChildren}</PasswordProtection>);
    ...
    it('should render session expiry info', () => {
      ...
      expect(screen.getByText(/session expires after 24 hours/i)).toBeInTheDocument();
    });
  });
  ...
  describe('Authentication - Failure', () => {
    ...
    it('should handle authentication errors gracefully', async () => {
      (bcrypt.compare as jest.Mock).mockRejectedValue(new Error('Network error'));
  ...
  describe('UI Styling', () => {
    it('should have gradient background', () => {
      ...
      expect(wrapper).toHaveClass('bg-gradient-to-br', 'from-gray-900', 'via-black', 'to-gray-900');
    });
