...
describe('SocialMedia Component', () => {
  ...
  describe('Layout and Styling', () => {
    it('should apply hover effects to entry containers', () => {
      ...
      expect(entryContainer).toHaveClass('hover:border-white/20', 'hover:bg-white/10');
    });
  ...
  describe('Accessibility', () => {
    ...
    it('should have descriptive title attributes on buttons', () => {
      ...
      const deleteButton = container.querySelector('button[title="Delete this social media"]');
